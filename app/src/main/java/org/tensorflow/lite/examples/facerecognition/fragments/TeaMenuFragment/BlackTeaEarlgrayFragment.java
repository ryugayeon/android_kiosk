...
public class BlackTeaEarlgrayFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = (ViewGroup) inflater.inflate(R.layout.fragment_black_tea_earlgray, container, false);

        black_tea_earlgray_btn = v.findViewById(R.id.black_tea_earlgray_btn);

        String content = black_tea_earlgray_btn.getText().toString();
        ...
        // 4
        black_tea_earlgray_btn.setText(spannableString);
