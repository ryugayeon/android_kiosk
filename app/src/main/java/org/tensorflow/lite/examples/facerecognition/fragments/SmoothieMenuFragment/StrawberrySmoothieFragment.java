...
public class StrawberrySmoothieFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = (ViewGroup) inflater.inflate(R.layout.fragment_strawberry_smoothie, container, false);

        strawberry_smoothie_btn = v.findViewById(R.id.strawberry_smoothie_btn);

        String content = strawberry_smoothie_btn.getText().toString();
        ...
        // 4
        strawberry_smoothie_btn.setText(spannableString);
