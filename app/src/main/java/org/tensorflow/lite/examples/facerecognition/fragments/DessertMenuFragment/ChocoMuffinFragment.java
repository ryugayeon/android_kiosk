...
public class ChocoMuffinFragment extends Fragment {

    private Button choco_muffin_btn;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        View v = (ViewGroup) inflater.inflate(R.layout.fragment_choco_muffin, container, false);

        choco_muffin_btn = v.findViewById(R.id.choco_muffin_btn);

        String content = choco_muffin_btn.getText().toString();
        ...
        // 4
        choco_muffin_btn.setText(spannableString);
