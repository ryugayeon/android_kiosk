...
public class GreenteaLatteFragment extends Fragment {

    private Button greentea_latte_btn;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        View v = (ViewGroup) inflater.inflate(R.layout.fragment_greentea_latte, container, false);

        greentea_latte_btn = v.findViewById(R.id.greentea_latte_btn);

        String content = greentea_latte_btn.getText().toString();
        ...
        // 4
        greentea_latte_btn.setText(spannableString);
