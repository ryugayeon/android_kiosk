...
public class CranberrySconeFragment extends Fragment {

    private Button cranberry_scone_btn;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        View v = (ViewGroup) inflater.inflate(R.layout.fragment_cranberry_scone, container, false);

        cranberry_scone_btn = v.findViewById(R.id.cranberry_scone_btn);

        String content = cranberry_scone_btn.getText().toString();
        ...
        // 4
        cranberry_scone_btn.setText(spannableString);
