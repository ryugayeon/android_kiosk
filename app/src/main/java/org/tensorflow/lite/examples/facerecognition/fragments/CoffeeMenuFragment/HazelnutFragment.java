...
public class HazelnutFragment extends Fragment {

    private Button hazzelnut_btn;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        View v = (ViewGroup) inflater.inflate(R.layout.fragment_hazelnut, container, false);

        hazzelnut_btn = v.findViewById(R.id.hazzelnut_btn);

        String content = hazzelnut_btn.getText().toString();
        ...
        // 4
        hazzelnut_btn.setText(spannableString);
