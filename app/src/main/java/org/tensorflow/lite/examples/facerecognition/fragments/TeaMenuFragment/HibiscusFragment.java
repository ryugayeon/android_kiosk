...
public class HibiscusFragment extends Fragment {

    private Button hibiscus_btn;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        View v = (ViewGroup) inflater.inflate(R.layout.fragment_hibiscus, container, false);

        hibiscus_btn = v.findViewById(R.id.hibiscus_btn);

        String content = hibiscus_btn.getText().toString();
        ...
        // 4
        hibiscus_btn.setText(spannableString);
