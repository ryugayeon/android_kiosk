...
public class ChocoTiramisuCakeFragment extends Fragment {

    private Button choco_tiramisu_cake_btn;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        View v = (ViewGroup) inflater.inflate(R.layout.fragment_choco_tiramisu_cake, container, false);

        choco_tiramisu_cake_btn = v.findViewById(R.id.choco_tiramisu_cake_btn);

        String content = choco_tiramisu_cake_btn.getText().toString();
        ...
        // 4
        choco_tiramisu_cake_btn.setText(spannableString);
