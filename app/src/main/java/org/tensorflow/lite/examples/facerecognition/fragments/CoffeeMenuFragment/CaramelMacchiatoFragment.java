...
public class CaramelMacchiatoFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = (ViewGroup) inflater.inflate(R.layout.fragment_caramel_macchiato, container, false);

        caramelmacchiato_btn = v.findViewById(R.id.caramelmacchiato_btn);

        String content = caramelmacchiato_btn.getText().toString();
        ...
        // 4
        caramelmacchiato_btn.setText(spannableString);
