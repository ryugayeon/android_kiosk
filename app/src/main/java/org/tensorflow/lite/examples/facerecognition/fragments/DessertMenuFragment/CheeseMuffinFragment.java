...
public class CheeseMuffinFragment extends Fragment {

    private Button cheese_muffin_btn;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        View v = (ViewGroup) inflater.inflate(R.layout.fragment_cheese_muffin, container, false);

        cheese_muffin_btn = v.findViewById(R.id.cheese_muffin_btn);

        String content = cheese_muffin_btn.getText().toString();
        ...
        // 4
        cheese_muffin_btn.setText(spannableString);
