...
public class OrangeJuiceFragment extends Fragment {

    private Button orange_juice_btn;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        View v = (ViewGroup) inflater.inflate(R.layout.fragment_orange_juice, container, false);

        orange_juice_btn = v.findViewById(R.id.orange_juice_btn);

        String content = orange_juice_btn.getText().toString();
        ...
        // 4
        orange_juice_btn.setText(spannableString);
