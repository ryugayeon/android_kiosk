...
public class EspressoFragment extends Fragment {
    ...
    private Button espresso_btn;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        View v = (ViewGroup) inflater.inflate(R.layout.fragment_espresso, container, false);

        espresso_btn = v.findViewById(R.id.espresso_btn);

        String content = espresso_btn.getText().toString();
        ...
        // 4
        espresso_btn.setText(spannableString);
