...
public class YogurtSmoothieFragment extends Fragment {

    private Button yogurt_smoothie_btn;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        View v = (ViewGroup) inflater.inflate(R.layout.fragment_yogurt_smoothie, container, false);

        yogurt_smoothie_btn = v.findViewById(R.id.yogurt_smoothie_btn);

        String content = yogurt_smoothie_btn.getText().toString();
        ...
        // 4
        yogurt_smoothie_btn.setText(spannableString);
