...
public class MochaBunFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = (ViewGroup) inflater.inflate(R.layout.fragment_mocha_bun, container, false);

        mocha_bun_btn = v.findViewById(R.id.mocha_bun_btn);

        String content = mocha_bun_btn.getText().toString();
        ...
        // 4
        mocha_bun_btn.setText(spannableString);
