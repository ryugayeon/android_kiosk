...
public class LemonTeaFragment extends Fragment {

    private Button lemon_tea_btn;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        View v = (ViewGroup) inflater.inflate(R.layout.fragment_lemon_tea, container, false);

        lemon_tea_btn = v.findViewById(R.id.lemon_tea_btn);

        String content = lemon_tea_btn.getText().toString();
        ...
        // 4
        lemon_tea_btn.setText(spannableString);
