...
public class YuzaTeaFragment extends Fragment {

    private Button yuza_tea_btn;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        View v = (ViewGroup) inflater.inflate(R.layout.fragment_yuza_tea, container, false);

        yuza_tea_btn = v.findViewById(R.id.yuza_tea_btn);

        String content = yuza_tea_btn.getText().toString();
        ...
        // 4
        yuza_tea_btn.setText(spannableString);
