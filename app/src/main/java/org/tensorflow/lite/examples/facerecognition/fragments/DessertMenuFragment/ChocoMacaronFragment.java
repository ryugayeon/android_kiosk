...
public class ChocoMacaronFragment extends Fragment {

    private Button choco_macaron_btn;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        View v = (ViewGroup) inflater.inflate(R.layout.fragment_choco_macaron, container, false);

        choco_macaron_btn = v.findViewById(R.id.choco_macaron_btn);

        String content = choco_macaron_btn.getText().toString();
        ...
        // 4
        choco_macaron_btn.setText(spannableString);
